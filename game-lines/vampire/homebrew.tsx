...
function VampireHomebrew({ catalogs }: GameLineHomebrewProps) {
  ...
  return <><MeritHomebrewPanel line="VtR" catalog={[...catalogs.get<readonly MeritDefinition[]>("core-merits"), ...catalogs.get<readonly MeritDefinition[]>("vampire-merits")]}/><section className="homebrew-panel">
