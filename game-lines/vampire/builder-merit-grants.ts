...
export const SHADOW_CULT_IDS = ["followers-of-seth", "inconnu", "moirai", "moulding-room"] as const;

const SHADOW_CULTS: Record<(typeof SHADOW_CULT_IDS)[number], { name: string; configuration: MeritConfiguration }> = {
  "followers-of-seth": { name: "Followers of Seth", configuration: { level_1_type: "specialty", level_1_specialty_skill: "Occult", level_1_specialty_name: "Spirits", level_2_type: "merit", level_2_merits: ["Demolisher|1"], level_3_type: "skill", level_3_skill: "Weaponry", level_4_type: "merit", level_4_merits: ["Medium|3"], level_5_type: "custom", level_5_custom: "Spend Willpower to make the vampire's blood a bane to spirits for the scene." } },
  inconnu: { name: "Inconnu", configuration: { level_1_type: "specialty", level_1_specialty_skill: "Investigation", level_1_specialty_name: "Kindred", level_2_type: "merit", level_2_merits: ["Alternate Identity|1"], level_3_type: "skill", level_3_skill: "Stealth", level_4_type: "merit", level_4_merits: ["Resources|3"], level_5_type: "custom", level_5_custom: "See past the Lost Visage according to Humanity." } },
  moirai: { name: "Moirai", configuration: { level_1_type: "specialty", level_1_specialty_skill: "Occult", level_1_specialty_name: "Prophecy", level_2_type: "merit", level_2_merits: ["Fast Reflexes|1"], level_3_type: "skill", level_3_skill: "Occult", level_4_type: "merit", level_4_merits: ["Anonymity|3"], level_5_type: "custom", level_5_custom: "Spend Willpower to act normally when surprised or take an instant action immediately before the foretold event." } },
  "moulding-room": { name: "The Moulding Room", configuration: { level_1_type: "specialty", level_1_specialty_skill: "Investigation", level_1_specialty_name: "Surveillance", level_2_type: "merit", level_2_merits: ["Trained Observer|1"], level_3_type: "skill", level_3_skill: "Expression", level_4_type: "merits", level_4_merits: ["Cacophony Savvy|3"], level_5_type: "merit", level_5_merits: ["Fame|3"] } },
};
