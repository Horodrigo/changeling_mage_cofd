...
export function synchronizeMageBuilderMeritGrants(sheet: CharacterSheet) {
  ...
  if (hasPublishedMageOrder(order)) {
    ...
    const configuration = { ...existing, cult: String(custom.name ?? ""), level_1_type: "merit", level_1_merits: ["High Speech|1"], level_2_type: "rote_skills", level_2_rote_skills: Array.isArray(existing.level_2_rote_skills) ? existing.level_2_rote_skills : legacyRoteSkills, level_3_type: "skill", level_3_skill: "Ocultismo" };
  ...
  if (nameless) {
    ...
    configuration.level_1_type = "merit"; configuration.level_1_merits = ["High Speech|1"]; configuration.level_2_type = "rote_skills"; configuration.level_3_type = "skill"; configuration.level_3_skill = "Ocultismo";
