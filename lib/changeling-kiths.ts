...
export const KITHS: KithDefinition[] = [
  kith("Absinthial","Ofícios","Fadas verdes que destilam as bebidas oníricas de Arcádia.","Uma vez por cena, gaste Glamour e teste Presença + Ofícios contra Autocontrole + Tolerância Sobrenatural para incapacitar alguém com a névoa dos sonhos.","Kith & Kin",88),
  kith("Airtouched","Esportes","Changelings desconectados do restante do mundo, que viveram nos céus de Arcádia.","Gaste Glamour para reduzir muito seu peso efetivo, tornando possíveis feitos impossíveis de equilíbrio.","Kith & Kin",107),
  kith("Antiquarian","Empatia","Guardiões de segredos e repositórios vivos de conhecimento.","Gaste Glamour e teste Inteligência + Autocontrole para buscar dentro de si a resposta para uma pergunta.","Dark Eras 2",69),
  ...
  kith("Bridgeguard","Intimidação","Changelings que lutam contra probabilidades impossíveis e se destacam quando estão em menor número.","Quando estiver em menor número, gaste Glamour para somar Autocontrole + Intimidação à Defesa e ignorar a penalidade por múltiplos ataques.","Kith & Kin",104),
  ...
  kith("Chimera","Dissimulação","Changelings animalescos costurados com partes de muitas feras de Arcádia.","Escolha um Contrato Goblin a cada história; usá-lo não gera Débito Goblin.","Changeling the Lost Jumpstart / Dark Eras 2",47),
  ...
  kith("Enkrateia","Empatia, Persuasão ou Dissimulação","Vozes da razão para seus Guardiões, conselheiros e mediadores de Arcádia.","Em investigações, só começa a perder dados no terceiro teste.","Kith & Kin",118),
  ...
  kith("Flowering","Socialização","Perdidos que viveram entre a flora de Arcádia e assimilaram seu fascínio passivo.","Gaste Glamour e teste Presença + Empatia para liberar perfume; presentes resistem com Autocontrole + Tolerância Sobrenatural ou ficam vulneráveis à sua influência.","Kith & Kin",90),
  kith("Flickerflash","Esportes","Perdidos feitos para correr depressa demais.","Gaste Glamour para triplicar seu Deslocamento.","Kith & Kin",110),
  ...
  kith("Glimmerwisp","Persuasão","Névoas de Faerie que encobrem atos vergonhosos e monstruosos.","Gaste Glamour para criar névoa perfumada; presentes resistem a Manipulação + Persuasão + Fado com Perseverança + Autocontrole ou deixam de perceber atos vergonhosos e pontos de ruptura.","Kith & Kin",94),
  ...
  kith("Hunterheart","Investigação","Caçadores que escaparam de uma Duração de predação sangrenta.","Gaste Glamour e confronte Presença + Fado contra Autocontrole + Tolerância Sobrenatural para paralisar ou afugentar alguém com o olhar.","Changeling the Lost",54),
  ...
  kith("Lethipomp","Empatia","Coletores sem emoção de lembranças dolorosas.","Gaste Glamour e confronte Autocontrole + Empatia + Fado para absorver as emoções de uma lembrança, recebendo uma Condição relacionada e podendo incitar outros a revivê-la.","Kith & Kin",99),
  kith("Levinquick","Computação","Batedores e mensageiros inquietos de paisagens digitais.","Gaste Glamour e teste Raciocínio + Esportes + Fado para viajar por redes conectadas por terra a até Fado milhas; Glamour adicional leva companheiros.","Kith & Kin",110),
  ...
  kith("Mirrorskin","Furtividade","Perdidos que aprenderam a esvaziar a própria natureza e tornar-se qualquer pessoa ou ninguém.","Gaste Glamour e teste Raciocínio + Dissimulação + Fado para remodelar Máscara e Aparência feérica.","Changeling the Lost",55),
  ...
  kith("Nightsinger","Expressão","Sereias e vocalistas cujas canções moviam a própria terra de Faerie.","Gaste Glamour e confronte Presença + Expressão + Fado contra Autocontrole + Tolerância Sobrenatural para deixar a plateia imóvel e extasiada.","Changeling the Lost",56),
  ...
  kith("Nymph","Esportes","Changelings que habitavam os oceanos e cursos d’água de Faerie.","Respire debaixo d’água e mova-se nela com o dobro do Deslocamento.","Dark Eras 2",70),
  ...
  kith("Shadowsoul","Dissimulação","Perdidos ligados às estrelas e à noite.","Receba afinidade com a Regalia Espelho; um sucesso excepcional em um ataque impõe Cegueira temporária.","Kith & Kin",119),
  ...
  kith("Snowskin","Dissimulação","Aqueles que escaparam de Faerie apagando o próprio calor e congelando-se.","Gaste Glamour e confronte Presença + Intimidação + Fado contra Autocontrole + Tolerância Sobrenatural para impor Abalado e afastar alguém da sociedade feérica.","Changeling the Lost",58),
  ...
  kith("Stoneflesh","Intimidação","Changelings duráveis de determinação e pele endurecidas.","Gaste Glamour e teste Vigor + Esportes + Fado para aumentar Armadura, Perseverança e/ou Autocontrole.","Kith & Kin",106),
  ...
  kith("Telluric","Condução ou Manha","Corpos celestes e estrelas sobre Arcádia.","Gaste Glamour para arremessar fogo estelar com Destreza + Esportes, causando dano como uma chama pequena de grande calor.","Kith & Kin",120),
  kith("Uttervoice","Intimidação","Changelings cuja frustração afiou a voz como uma lâmina.","Gaste Glamour e confronte Presença + Fado contra Autocontrole + Tolerância Sobrenatural para causar dano contundente e estilhaçar vidro apenas com a voz.","Kith & Kin",92),
