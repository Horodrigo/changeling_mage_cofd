...
const CTL_SUPPLEMENTS = [
  ...
  ...[
    ...
    ["Still Waters Run Deep",fixed(3)],["Stomach of Steel",fixed(1)],["Fire-Forged Friends",fixed(2)],["Multimask",fixed(2)],["Not Just a Pretty Face",fixed(1)],["Confessional Countenance",fixed(1)],["Power Behind the Throne",range(1,3)],
