...
const ENGLISH_TERMS: Record<string,string> = {
  ...
  "Feitiço":"Spell",
  "Méritos":"Merits",
  "Méritos Expandidos":"Expanded Merits",
  "Aspirações":"Aspirations",
  "Obsessões":"Obsessions",
  "Fragilidades":"Frailties",
  "Pedras de Contato":"Touchstones",
  "Condições":"Conditions",
  "Nimbus":"Nimbus",
  "Feitiços Ativos":"Active Spells",
  "Regalias Favorecidas":"Favored Regalia",
  "Contratos":"Contracts",
  "Débito Goblin":"Goblin Debt",
  "Juramentos":"Oaths",
  "Arcanos":"Arcana",
  "Rotas":"Rotes",
  "Práxis":"Praxes",
  "Attainments":"Attainments",
  "Ferramentas Mágicas":"Magical Tools",
  "Inclinação do Nimbus":"Nimbus Tilt",
  "Itens Encantados":"Enchanted Items",
  "Condições do Paradoxo":"Paradox Conditions",
  "Vitalidade":"Health",
  "Características da Linha":"Line Traits",
  "Outras Características":"Other Traits",
  "Escolhas dos Méritos":"Merit Choices",
  "Armadura":"Armor",
  "Armas":"Weapons",
  ...
  "Defesa":"Defense",
  "Deslocamento":"Speed",
  "Armadura geral":"General Armor",
  "Armadura balística":"Ballistic Armor",
  "Bênção da Fratria":"Kith Blessing",
  "Bênção da Feição":"Seeming Blessing",
  "Maldição da Feição":"Seeming Curse",
