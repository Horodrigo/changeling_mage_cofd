...
const court = (
  ...
  options: Pick<CourtDefinition, "additionalPages" | "glamourTrigger" | "glamourTriggerPt"> = {},
): CourtDefinition => {
  return {
    id, name, translatedName, emotion, emotionPt, mantleBenefits, mantleBenefitsPt, ...options,
    sourceId,
    source: sourceId === "ctl-2ed" ? "CTL 2e" : sourceId === "h-courts" ? "Book of Courts" : "DE2",
    page,
  };
};
...
export const CTL_COURT_DEFINITIONS: CourtDefinition[] = [
  ...
  ], "ctl-2ed", { additionalPages: [117, 165] }),
  ...
  ], "ctl-2ed", { additionalPages: [118, 165] }),
  ...
  court("society-morning", "Society of Morning", "Sociedade da Manhã", "Passion", "Paixão", 279, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Gaining new knowledge through reckless pursuit", glamourTriggerPt: "Obter conhecimento novo por meio de uma busca imprudente" }),
  court("society-day", "Society of Day", "Sociedade do Dia", "Restraint", "Contenção", 279, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Resolving a conflict between two changelings", glamourTriggerPt: "Resolver um conflito entre dois changelings" }),
  court("society-night", "Society of Night", "Sociedade da Noite", "Satisfaction", "Satisfação", 279, [
  ...
  ], "ctl-2ed", { additionalPages: [280], glamourTrigger: "Following a hunt to its logical conclusion", glamourTriggerPt: "Levar uma caçada à sua conclusão lógica" }),
  court("spring-lag", "Spring Lag", "Lag da Primavera", "Desire", "Desejo", 283, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Convincing someone to abandon an established plan", glamourTriggerPt: "Convencer alguém a abandonar um plano estabelecido" }),
  court("summer-lag", "Summer Lag", "Lag do Verão", "Wrath", "Ira", 283, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Taking a risk to fulfill an obligation", glamourTriggerPt: "Correr um risco para cumprir uma obrigação" }),
  court("autumn-lag", "Autumn Lag", "Lag do Outono", "Fear", "Medo", 284, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Succeeding at something in an unnecessarily risky way", glamourTriggerPt: "Ter sucesso em algo de maneira desnecessariamente arriscada" }),
  court("winter-lag", "Winter Lag", "Lag do Inverno", "Sorrow", "Tristeza", 284, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Definitively winning a significant fight", glamourTriggerPt: "Vencer definitivamente uma luta significativa" }),
  court("high-tide", "Court of High Tide", "Corte da Maré Alta", "Dominance", "Dominância", 287, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Opening someone's last Door in Social maneuvering", glamourTriggerPt: "Abrir a última Porta de alguém em uma manobra Social" }),
  court("ebb-tide", "Court of Ebb Tide", "Corte da Maré Vazante", "Mercy", "Misericórdia", 287, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Talking someone down from a fight", glamourTriggerPt: "Dissuadir alguém de lutar" }),
  court("low-tide", "Court of Low Tide", "Corte da Maré Baixa", "Vulnerability", "Vulnerabilidade", 287, [
  ...
  ], "ctl-2ed", { additionalPages: [288], glamourTrigger: "Using secrets to foil someone's plan", glamourTriggerPt: "Usar segredos para frustrar o plano de alguém" }),
  court("flood-tide", "Court of Flood Tide", "Corte da Maré Enchente", "Acceptance", "Aceitação", 288, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Executing a plan without any participant failing a roll", glamourTriggerPt: "Executar um plano sem que nenhum participante falhe em um teste" }),
  court("coins", "Court of Coins", "Corte das Moedas", "Selfishness", "Egoísmo", 291, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Finding and obtaining something owed", glamourTriggerPt: "Encontrar e obter algo devido" }),
  court("barter", "Court of Barter", "Corte do Escambo", "Fairness", "Justiça", 291, [
  ...
  ], "ctl-2ed", { additionalPages: [292], glamourTrigger: "Interceding on someone else's behalf in an unfair deal", glamourTriggerPt: "Interceder em favor de outra pessoa em um acordo injusto" }),
  court("favors", "Court of Favors", "Corte dos Favores", "Honesty", "Honestidade", 292, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Making good on a significant promise made in the same chapter", glamourTriggerPt: "Cumprir uma promessa significativa feita no mesmo capítulo" }),
  court("shady-deals", "Court of Shady Deals", "Corte dos Negócios Escusos", "Regret", "Arrependimento", 292, [
  ...
  ], "ctl-2ed", { glamourTrigger: "Hiding evidence of a dirty deed when someone comes looking for it", glamourTriggerPt: "Ocultar provas de um ato sujo quando alguém vier procurá-las" }),
  ...
  court("leafless-tree", "Court of the Leafless Tree", "Corte da Árvore Desfolhada", "Punishing someone genuinely believed guilty", "Punir alguém que acredita ser culpado", 384, [
