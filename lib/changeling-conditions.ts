...
const CONDITION_TEXT_EN: Record<string, ConditionEnglishText> = {
  ...
  "behind-your-eyes":{description:"A Hedge ghost, hobgoblin, or True Fae shares the changeling's senses and may uncover their secrets.",resolution:"Regain Clarity or reveal an important secret to the visitor. If severe Clarity damage caused it, revealing a secret is the only resolution."},
  comatose:{description:"At Clarity zero, the changeling retreats into a continuous dream they believe is reality."},
  cursed:{description:"A curse imposed by another changeling persists while the victim maintains its specified routine or requirement.",resolution:"The changeling who placed the curse fails to maintain its required state or perform its specified action.",beat:"Suffer a significant setback directly because of the curse."},
  "deep-kenning":{description:"Restored Clarity grants a flash of insight into nearby supernatural phenomena.",resolution:"Shed the Condition to ken nearby supernatural phenomena with successes equal to half maximum Clarity and allow a Clash of Wills against magical concealment."},
  ...
  egomaniac:{description:"Without Clarity, the changeling imitates the boundless ego of the True Fae and ignores other people's needs.",penalty:"Failures on Social rolls become dramatic failures without granting a Beat.",resolution:"Regain Clarity or seriously harm an ally through these actions. If severe Clarity damage caused it, harming an ally is the only resolution."},
  "enchanted-obligation":{description:"An enchanted bargain protects the changeling while granting a mortal sight through the Mask and access to fae assistance.",resolution:"The mortal completes or escapes the bargained task, or either party fails to uphold the bargain; both players gain a Beat."},
  "glamour-addicted":{description:"The character's body deteriorates when they do not regularly consume enough Glamour."},
  hexed:{description:"A changeling has imposed a temporary inconvenience that ends only when the specified action or mission is completed.",resolution:"Take the action specified when the hex was placed."},
  "icon-shard":{description:"A broken oath has given malicious life to a fragment of the Icon, which now torments the changeling.",resolution:"Kill the Icon shard or make amends for breaking the word, fulfilling a vow or reconciling the oath with its participants or the Wyrd.",beat:"The shard harms the changeling or someone she values, or prevents Willpower recovery through Needle or Thread."},
  indebted:{description:"The character owes a service to a fae being and may repay it by accepting damage, a detrimental Condition, or a Personal Tilt.",resolution:"Repay the debt by accepting the entire harm meant for the debtor; a Persistent debt requires a major service.",beat:"While Persistent, fulfill the debtor's request or demand without rolling to resist."},
  kithseeker:{description:"The changeling must face five trials in the Hedge to find a Kith matching the call of their soul.",resolution:"Overcome five trials and gain a new Kith.",beat:"Endure significant adversity or learn something new about yourself during a trial."},
