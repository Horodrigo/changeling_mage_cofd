...
function meritCategoryLabel(category:string) { return ({ Mental:"Mentais",Physical:"Físicos",Social:"Sociais",Supernatural:"Sobrenaturais","Fighting Style":"Estilos de Combate",Changeling:"Changelings",Awakened:"Despertos",Entitlement:"Entitlements",Court:"Cortes",Seeming:"Seemings",Historical:"Históricos",Order:"Ordens","Mystery Cult":"Cultos de Mistério" } as Record<string,string>)[category] ?? category; }
