...
export type ContractSelection = Pick<ContractDefinition, "id" | "name" | "originalName" | "type" | "regalia" | "description" | "dicePool" | "loophole" | "seemingBenefits" | "sourceId" | "source" | "page">;
...
function contractTooltip(contract: Pick<ContractDefinition,"description"|"dicePool"|"loophole"|"seemingBenefits">, seeming:string) { const benefit=contract.seemingBenefits?.[seeming as keyof typeof contract.seemingBenefits]; return contract.description ? `${contract.description}\nParada de dados: ${contract.dicePool ?? "Não informada"}\nBrecha: ${contract.loophole??"Não informada"}${benefit?`\nBenefício de ${CTL_SEEMING_LABELS[seeming]??seeming}: ${benefit}`:""}` : ""; }
