  ...
  return <article className={`cod-sheet ${isCtl?"ctl-sheet":"mta-sheet"}`}>
    ...
    <div className="official-sheet-body">
      ...
      <div className="sheet-right-column">
        ...
        <SheetHeading>Outras Características</SheetHeading><CompactValues values={{...derived,ForçaDeVontade:willpower}}/>
    ...
    <Tabs defaultValue="principal" className="ctl-sheet-tabs mta-sheet-tabs">
      ...
      <TabsContent value="magia" className="ctl-sheet-page powers-page mage-spell-page">
        ...
        <div className="mage-page-355-grid">
          ...
          <section className="mage-page-main"><SheetHeading>Rotas</SheetHeading><SpellColumn items={rotes} showSkill/><SheetHeading>Inclinação do Nimbus</SheetHeading><EditableList values={stringList(data.nimbus_tilt)} minimum={2} placeholder="Descrição da Inclinação do Nimbus" onChange={(value)=>updateLineData(updateSheet,character,"nimbus_tilt",value)}/><SheetHeading>Itens Encantados</SheetHeading><EditableList values={stringList(data.enchanted_items)} minimum={4} placeholder="Tipo · Poder · Parada de Dados · Mana" onChange={(value)=>updateLineData(updateSheet,character,"enchanted_items",value)}/><SheetHeading>Combate</SheetHeading><CompactValues values={{Vitalidade:health,"Força de Vontade":willpower,Defesa:Number(derived.Defesa??0),Iniciativa:Number(derived.Iniciativa??0),Deslocamento:Number(derived.Deslocamento??0)}}/><SheetHeading>Familiar</SheetHeading><EditableList values={stringList(data.familiar)} minimum={5} placeholder="Nome, posto, descrição, poderes ou Numina" onChange={(value)=>updateLineData(updateSheet,character,"familiar",value)}/><SheetHeading>Anotações</SheetHeading><NotesArea value={notes} onChange={(value)=>setState("notes",value)}/></section>
        </div>
      </TabsContent>
    </Tabs>}
  </article>;
