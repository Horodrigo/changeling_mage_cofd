const VERSION = "2026.09.13-changeling-style-6";
const CACHE = `characters-of-the-darkness-${VERSION}`;
const SHELL = ["/", "/manifest.webmanifest", "/data/manifest.json", "/favicon.svg", "/app-icon-192.png", "/app-icon-512.png", "/cod-emblem-256.webp", "/changeling-paper-texture.webp", "/changeling-skull.png", "/kith-skill-stamp.webp", "/mage-skull.png", "/fonts/changeling/changeling-regular.woff2", "/fonts/changeling/changeling-italic.woff2", "/fonts/changeling/changeling-small-caps.woff2", "/changeling/style/divider-arm.webp", "/changeling/style/botanical-corner.webp", "/changeling/style/frame-star-center.webp", "/changeling/style/frame-star-side.webp", "/changeling/style/panel-node.webp", "/changeling/style/changeling-title.webp", "/changeling/style/selected-tab-texture.webp", "/changeling/style/attributes-divider.webp", "/changeling/style/divider-terminal.webp", "/changeling/style/vertical-rule.webp", "/version.json"];
